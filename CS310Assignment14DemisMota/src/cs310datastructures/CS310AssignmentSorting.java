...
public class CS310AssignmentSorting
{
    ...
    */
	...
	/**
	 * The main method aka the driver of the program
    ...
    /**
	 * Drive Method to run a test on a specific type of sorting algorithm
	 * @param sortName type of sort
	 * @param testNum which test number this is
	 * @param sizeNum which array index this is 
	 * @param arrayToSort the array that needs sorting
	 * @param sortResults the test result 2D array with testType and ArraySize
	 * @return a boolean variable whether the sort passed or failed
	 */
	...
	/**
	 * Displays the test Results in a nice table
	 * @param sortName The Sort Name for the Table
	 * @param results The results 2D array which contains the test results
	 */
	...
	/**
	 * Creates a Comma Separated Value file to view in Excel or other CSV file
	 * reader.
	 * @param filename the name of the file to create
	 * @param bubbleResults The 2D array with the test results for bubbleSort
	 * @param selectionResults The 2D array with the test results for selectionSort
	 * @param insertionResults The 2D array with the test results for insertionSort
	 * @param shellResults The 2D array with the test results for shellSort
	 * @param mergeResults The 2D array with the test results for mergeSort
	 * @param quickResults The 2D array with the test results for quickSort
	 * @param javaResults The 2D array with the test results for java's Sort
	 * @return a boolean variable if the CSV file was created successfully
	 */
    ...
    /**
	 * Format's and outputs a test table to a PrintWriter object
	 * @param writer the PrintWriter we wish to use
	 * @param sortName the sort we are making a table for
	 * @param sortResults the 2D array with specific sort's test results
	 */
